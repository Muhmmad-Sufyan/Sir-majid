...
const Footer = () => {
    return (
        <div className='contanier-xl md:w-[80%] 2xl:w-[75%] md:mx-auto rounded-2xl border-[1px] mt-20 mb-10 p-8 text-white' style={{background: 'linear-gradient(195.05deg, rgba(37, 85, 212, 0.1) 0%, rgba(37, 85, 212, 0.02) 50%, rgba(37, 85, 212, 0.06) 100%)'}}>
            <img src='/logo.png' />
