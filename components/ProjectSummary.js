...
const ProjectSummary = () => {
    return (
        <div className='md:mx-20 mx-4 border-[1px] rounded-2xl p-8 flex gap-1 my-10 md:flex-row flex-col'>
            ...
            <div className=' flex justify-center md:mt-20 mt-10 md:w-[50%] w-[100%]'>
                ...
                <img src="/s7.png" className='z-50  flex md:opacity-70 md:-mt-16 -mt-8 sm:opacity-80 opacity-100 w-auto '  />
